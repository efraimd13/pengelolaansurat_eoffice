                                ...
                                <div class="col m12" id="colres">
                                    <table class="bordered" id="tbl">
                                        ...
                                        if(mysqli_num_rows($query2) > 0){
                                         ...
                                         $query2 = mysqli_query($config, "SELECT * FROM tbl_disposisi JOIN tbl_surat_masuk ON tbl_disposisi.id_surat = tbl_surat_masuk.id_surat WHERE tbl_disposisi.id_surat='$id_surat' and status='1'" );
                                        ...
                                        if(mysqli_num_rows($query2) > 0){
                                            ...
                                            echo '<tr><td colspan="5"><center><p class="add">Tidak ada data untuk ditampilkan. <u></u></p></center></td></tr>';
                                        }
                                    }elseif($_SESSION['admin'] == 6){
                                         $query2 = mysqli_query($config, "SELECT * FROM tbl_disposisi JOIN tbl_surat_masuk ON tbl_disposisi.id_surat = tbl_surat_masuk.id_surat WHERE tbl_disposisi.id_surat='$id_surat' and status='2'" );
                                        ...
                                        if(mysqli_num_rows($query2) > 0){
                                         ...
                                         $query2 = mysqli_query($config, "SELECT * FROM tbl_disposisi JOIN tbl_surat_masuk ON tbl_disposisi.id_surat = tbl_surat_masuk.id_surat WHERE tbl_disposisi.id_surat='$id_surat' and status='3'" );
