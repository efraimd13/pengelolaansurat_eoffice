            ...
            if(isset($_REQUEST['act'])){
                ...
                <?php
                    ...
                    <!-- Row form END -->';
                                   ...
                                   $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk where approval_superadmin=0 or approval_sekretaris=1 or status_feedback = 1 or status_disposisi = 4 ORDER by id_surat DESC LIMIT $curr, $limit ");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
                                      <tr>
                                        ...
                                        // }  else if ($row['approval_sekretaris']==1 and $row['approval_superadmin']==1  and $row['status_disposisi'] == 4 ) {
                                        //     echo '</td>
                                        //     <td>'.$row['asal_surat'].'</td>
                                        ...
                                        //          </td>
                                        //     </tr>';
                                        }else if ($row['approval_sekretaris']==1 and $row['approval_superadmin']==1  and $row['status_feedback'] == 4 ) {
                                            echo '</td>
                                            <td>'.$row['asal_surat'].'</td>
                                ...
                                if(mysqli_num_rows($query) > 0){
                                    ...
                                    while($row = mysqli_fetch_array($query)){
                                      ...
                                      <tr>
                                        ...
                                        }elseif ($row['approval_sekretaris']==1 and $row['approval_superadmin']==1 and $row['status_disposisi']==1) {
                                            echo '</td>
                                        <td>'.$row['asal_surat'].'</td>
                                        <td>Belum Disposisi Ke Kabid</td>
                                        <td>'.$row['no_surat'].'<br/><hr/>'.indoDate($row['tgl_surat']).'</td>
                                        <td>
                                        <a class="btn small blue waves-effect waves-light" href="?page=tsm&act=edit&id_surat='.$row['id_surat'].'">
                                                <i class="material-icons">edit</i> EDIT</a>
                                        ...
                                        }elseif ($row['approval_sekretaris']==1 and $row['approval_superadmin']==1 and $row['status_feedback']==3) {
                                             echo '</td>
                                        <td>'.$row['asal_surat'].'</td>
                                        <td>Belum Feedback Ke Kaban</td>
                                        <td>'.$row['no_surat'].'<br/><hr/>'.indoDate($row['tgl_surat']).'</td>
                                        <td>
                                        <a class="btn small blue waves-effect waves-light" href="?page=tsm&act=edit&id_surat='.$row['id_surat'].'">
                                                <i class="material-icons">edit</i> EDIT</a>
                                            <a class="btn small green waves-effect waves-light" href="?page=tsm&act=tindakan&id_surat='.$row['id_surat'].'">
                                                <i class="material-icons">search</i> Detail</a>
                                            <a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat='.$row['id_surat'].'" target="_blank">
                                                <i class="material-icons">print</i> PRINT</a>
                                            <a class="btn small deep-orange waves-effect waves-light" href="?page=tsm&act=del&id_surat='.$row['id_surat'].'">
                    ...
                    <!-- Row form END -->';
                                      ...
                                      $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk where approval_sekretaris = 1 and approval_superadmin=1 and status_feedback =2  or status_disposisi =2 ORDER by id_surat DESC LIMIT $curr, $limit ");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
                                      <tr>
                                        ...
                                        if(!empty($row['file'])){
                                            ...
                                            echo '<em>Tidak ada file yang di upload</em>';
                                        } if ($row['approval_sekretaris']==1 and $row['approval_superadmin']==1 and $row['status_disposisi']==2) {
                                            echo '</td>
                                        <td>'.$row['asal_surat'].'</td>
                                        <td>Belum Disposisi Ke Kasub</td>
                                        <td>'.$row['no_surat'].'<br/><hr/>'.indoDate($row['tgl_surat']).'</td>
                                        <td>
                                        <a class="btn small blue waves-effect waves-light" href="?page=tsm&act=edit&id_surat='.$row['id_surat'].'">
                                                <i class="material-icons">edit</i> EDIT</a>
                                        ...
                                        }elseif ($row['approval_sekretaris']==1 and $row['approval_superadmin']==1 and $row['status_feedback']==2) {
                                             echo '</td>
                                        <td>'.$row['asal_surat'].'</td>
                                        <td>Belum Feedback Ke Sekretaris</td>
                                        <td>'.$row['no_surat'].'<br/><hr/>'.indoDate($row['tgl_surat']).'</td>
                                        <td>
                                        <a class="btn small blue waves-effect waves-light" href="?page=tsm&act=edit&id_surat='.$row['id_surat'].'">
                                                <i class="material-icons">edit</i> EDIT</a>
                    ...
                    <!-- Row form END -->';
                                }elseif ($_SESSION['admin'] == 7) {
                                    $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk where approval_sekretaris = 1 and status_feedback =1  and approval_superadmin=1 or status_disposisi =3 ORDER by id_surat DESC LIMIT $curr, $limit ");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
                                      <tr>
                                        ...
                                        if(!empty($row['file'])){
                                            ...
                                            echo '<em>Tidak ada file yang di upload</em>';
                                        } if ($row['approval_sekretaris']==1 and $row['approval_superadmin']==1 and $row['status_disposisi']==3) {
                                            echo '</td>
                                        <td>'.$row['asal_surat'].'</td>
                                        <td>Belum Diposisi Ke User</td>
                                        <td>'.$row['no_surat'].'<br/><hr/>'.indoDate($row['tgl_surat']).'</td>
                                        <td>
                                        <a class="btn small blue waves-effect waves-light" href="?page=tsm&act=edit&id_surat='.$row['id_surat'].'">
                                                <i class="material-icons">edit</i> EDIT</a>
