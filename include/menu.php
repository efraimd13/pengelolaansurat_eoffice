...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="smk-side">Badan Pendapatan Daerah Provinsi Sulawesi Utara</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jalan 17 Agustus Nomor 67 Sulawesi Utara</p>';
                            }
                        }
                    ?>
                </div>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            ...
            <?php
                if($_SESSION['admin'] == 1 or $_SESSION['admin'] == 2 or $_SESSION['admin'] == 3 or $_SESSION['admin'] == 5 or $_SESSION['admin'] == 6 or $_SESSION['admin'] == 7){ ?>
